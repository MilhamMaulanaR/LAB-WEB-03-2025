...
function tulisLog(actionMsg) {
  const nextTurnText = keadaan.turn === 'player' ? 'Giliran Anda' : 'Giliran Bot';
  logEl.innerHTML = `<div>${actionMsg} — ${nextTurnText}</div>`;
}
...
/* ===================== Render UI (pembaharuan tampilam)===================== */
...
/* ===================== Bot (sederhana)Jika kartu yang diambil bisa dimainkan, pemain boleh langsung memainkannya atau
melewati giliran. ===================== */
function giliranBot() {
