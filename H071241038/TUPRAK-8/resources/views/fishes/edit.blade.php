...
@section('content')
    <h1 class="text-3xl font-bold text-gray-800 mb-6">Edit Fish: {{ $fish->name }}</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <input type="text" name="name" id="name" 
                           value="{{ old('name', $fish->name) }}" {{-- Data lama atau data dari DB --}}
                ...
                <div>
                    ...
                    <input type="number" name="base_weight_min" id="base_weight_min" 
                ...
                <div>
                    ...
                    <input type="number" name="base_weight_max" id="base_weight_max" 
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="number" name="catch_probability" id="catch_probability" 
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="5"
                              ...
                              placeholder="A short description about the fish...">{{ old('description', $fish->description) }}</textarea>
                    @error('description')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
